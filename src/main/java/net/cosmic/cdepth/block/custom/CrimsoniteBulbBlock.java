...
public class CrimsoniteBulbBlock extends Block {
    ...
    public CrimsoniteBulbBlock(Settings settings) {
        super(settings);
    ...
    public void update(BlockState state, ServerWorld world, BlockPos pos) {
        ...
        if (bl != (Boolean)state.get(POWERED)) {
            ...
            if (!(Boolean)state.get(POWERED)) {blockState = (BlockState)blockState.cycle(LIT);}
    ...
    static {POWERED = Properties.POWERED; LIT = Properties.LIT;}
}
