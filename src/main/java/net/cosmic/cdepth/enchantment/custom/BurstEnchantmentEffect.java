...
public class BurstEnchantmentEffect implements EnchantmentEntityEffect {
    public static final MapCodec<BurstEnchantmentEffect> CODEC = MapCodec.unit(BurstEnchantmentEffect::new);
